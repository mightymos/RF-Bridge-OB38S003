...
typedef enum
{
  SMB0_TIMER0      = SMBCS__TIMER0,      //!< Select SystemClock/12
  SMB0_TIMER1      = SMBCS__TIMER1,      //!< Select SystemClock/4
  SMB0_TIMER2_HIGH = SMBCS__TIMER2_HIGH, //!< Select Timer0 Overflow
  SMB0_TIMER2_LOW  = SMBCS__TIMER2_LOW,  //!< Select ECI falling edge
} SMB0_Timebase_t;
 ...
 ******************************************************************************/
extern void SMB0_startCb(void);  //master only
 ...
 * another slave.
 ******************************************************************************/
extern void SMB0_addressCb(void);   // slave only
 ...
 *
 ******************************************************************************/
extern void SMB0_stopCb(void);      // slave only
#endif // !EFM8PDL_SMB0_USE_BUFFER
 ...
 ******************************************************************************/
extern void SMB0_transferCompleteCb(void);
 ...
 *
 ******************************************************************************/
extern void SMB0_commandReceivedCb(void);
